...
*We allow users to take Dappies from our smart contract to their account. For this, they need to enable a collection.*
...
## Check for collection: Scripts with arguments
...
## Create collection: Your first transaction
...
## Summing up: deleting collection
