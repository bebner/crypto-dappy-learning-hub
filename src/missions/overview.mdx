...
### 🛒  [Market Mission #1](/missions/market-mission-1) Orientation
Chec
k out the market starter application and learn about marketplaces on Flow.

### 📝  [Market Mission #2](/missions/market-mission-2) List Dappy on Market
Learn how to list a Dappy on the market using the DappyMarket contract and a transaction.


### 🔁  [Market Mission #3](/missions/market-mission-3) Update Market
Using an API request and a Cadence script, update the market with the latest listed Dappies.


### ❌  [Market Mission #4](/missions/market-mission-4) Remove Dappy from Market
Create a Cadence transaction that removes one of your Dappies from the market.


### 💸  [Market Mission #5](/missions/market-mission-5) Buy Dappy from Market
Purchase another user's Dappy from the market by creating a Cadence transaction.


### 💻  [Market Mission #6 (Bonus)](/missions/market-mission-6) Deployment Part 1
Learn how to deploy your project to testnet, how to update a deployed contract, and how to interact with contracts using the CLI.


### 💻  [Market Mission #7 (Bonus)](/missions/market-mission-7) Deployment Part 2
Create your own AWS event monitoring backend using AWS CloudFormation and investigate how it works.
