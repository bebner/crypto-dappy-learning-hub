...
At CryptoDappy, accessible from https://www.cryptodappy.com, 
one of our main priorities is the privacy of our visitors. 
This Privacy Policy document contains types of information 
that is collected and recorded by CryptoDappy and how we use it.
...
regards to the information that they shared and/or collect in CryptoDappy. This policy is not applicable 
...
CryptoDappy follows a standard procedure of using log files. These files log visitors when they visit websites. 
...
Like any other website, CryptoDappy uses 'cookies'. These cookies are used to store information including 
...
You may consult this list to find the Privacy Policy for each of the advertising partners of CryptoDappy.

Third-party ad servers or ad networks uses technologies like cookies, JavaScript, 
or Web Beacons that are used in their respective advertisements and links that appear on CryptoDappy, 
...
Note that CryptoDappy has no access to or control over these cookies that are used by third-party advertisers.

### Third Party Privacy Policies
CryptoDappy's Privacy Policy does not apply to other advertisers or websites. 
...
CryptoDappy does not knowingly collect any Personal Identifiable Information from children under the age of 13. 
